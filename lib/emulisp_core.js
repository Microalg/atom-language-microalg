...
function getFileLocal(filePath) {
	return fs.readFileSync(
	path.resolve(__dirname, filePath)).toString();
}
...
function loadLispLocal(filePath) {
	return loadLispStr(getFileLocal(filePath));
}
...
var pub = {
	...
	loadLisp: loadLisp, loadLispLocal: loadLispLocal, oadLispStr: loadLispStr, newErrMsg: newErrMsg, newTransSymbol: newTransSymbol,
